...
public static class Localizer
{
    private static readonly Dictionary<string, Dictionary<string, string>> Languages = new()
    {
        ["en-US"] = new Dictionary<string, string>
        {
            ...
            ["RangeApplied"] = "{0:yyyy/MM/dd HH:mm}  –  {1:yyyy/MM/dd HH:mm}",
            ["RangeEdit"] = "Edit",
            ["TestBuild"] = "Test build",
            ["StableBuild"] = "Official release",
            ["AutoUpdates"] = "Check GitHub for updates at startup (once a day)",
            ["UpdateTitle"] = "Updates",
            ["UpdateSource"] = "Source: GitHub · mgliz/FlowLens",
            ["CheckUpdates"] = "Check for updates",
            ["CheckingUpdates"] = "Checking GitHub…",
            ["NoUpdates"] = "You're running the latest official version.",
            ["UpdateAvailable"] = "Official release {0} is available.",
            ["StableAvailable"] = "Test build installed. You can switch to official release {0}.",
            ["InstallUpdate"] = "Download and update",
            ["InstallStable"] = "Switch to official release",
            ["UpdateDownloading"] = "Downloading and verifying… {0:0}%",
            ["UpdatePreparing"] = "Preparing update. FlowLens will save its history and restart.",
            ["UpdateFailed"] = "Update failed: {0}",
            ["UpdateCancelled"] = "Download cancelled.",
            ["UpdateNoRelease"] = "No compatible official release is available.",
            ["UpdateConfirm"] = "Install GitHub release {0}? FlowLens will save its history and restart. The test build's unreleased features will be replaced by the official version.",
            ["UpdateConfirmStable"] = "Install GitHub release {0}? FlowLens will save its history and restart.",
            ["RangeEditorTitle"] = "Choose a period",
            ["HourlyHistoryShort"] = "Older history: daily totals",
        ...
        ["zh-CN"] = new Dictionary<string, string>
        {
            ...
            ["TestBuild"] = "测试版",
            ["StableBuild"] = "正式版",
            ["AutoUpdates"] = "启动时检查 GitHub 更新（每天一次）",
            ["UpdateTitle"] = "软件更新",
            ["UpdateSource"] = "更新来源：GitHub · mgliz/FlowLens",
            ["CheckUpdates"] = "检查更新",
            ["CheckingUpdates"] = "正在检查 GitHub…",
            ["NoUpdates"] = "当前已是最新正式版。",
            ["UpdateAvailable"] = "发现正式版 {0}。",
            ["StableAvailable"] = "当前为测试版，可切换到正式版 {0}。",
            ["InstallUpdate"] = "下载并更新",
            ["InstallStable"] = "切换到正式版",
            ["UpdateDownloading"] = "正在下载并校验… {0:0}%",
            ["UpdatePreparing"] = "正在准备更新，FlowLens 将保存历史并重启。",
            ["UpdateFailed"] = "更新失败：{0}",
            ["UpdateCancelled"] = "已取消下载。",
            ["UpdateNoRelease"] = "暂未找到兼容的正式发布版。",
            ["UpdateConfirm"] = "安装 GitHub 正式版 {0}？FlowLens 将保存历史并重启；当前测试版尚未发布的功能会替换为正式版功能。",
            ["UpdateConfirmStable"] = "安装 GitHub 正式版 {0}？FlowLens 将保存历史并重启。",
            ["RangeEditorTitle"] = "选择统计时段",
            ["HourlyHistoryShort"] = "旧历史仅支持整天",
            ["SettingsTitle"] = "设置",
