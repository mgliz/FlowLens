...
public static class Localizer
{
    private static readonly Dictionary<string, Dictionary<string, string>> Languages = new()
    {
        ["en-US"] = new Dictionary<string, string>
        {
            ...
            ["Language"] = "Language",
            ["StartupNote"] = "Startup uses the current user's Run registry key. Because FlowLens needs administrator privileges, Windows may show UAC at login.",
            ["Theme"] = "Theme",
        ...
        ["zh-CN"] = new Dictionary<string, string>
        {
            ...
            ["Language"] = "语言",
            ["StartupNote"] = "开机启动使用当前用户的 Run 注册表项。由于 FlowLens 需要管理员权限，登录时 Windows 可能会显示 UAC。",
            ["Theme"] = "主题",
            ["ThemeSystem"] = "跟随系统",
            ["ThemeDark"] = "深色",
            ["ThemeLight"] = "浅色",
